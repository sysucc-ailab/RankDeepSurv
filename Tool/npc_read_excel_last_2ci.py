...
if __name__ == '__main__':
    textpath = '/media/sysucc99/data/ZTROOT/2017MainText/excel file/NPC/npc_last_all _2ci.xlsx'

    factors = [u'性别', u'T分期UICC七', u'N分期UICC七', u'CRP', u'LDH',u'年龄', u'HGB',  u'BMI',u'EBVDNA','PFSmonths',u'outcome']
    ...
    file = h5py.File('/media/sysucc99/data/ZTROOT/2017MainText/data/NPC/npc_B_excel_last_2_PFSmonths.h5', 'w')
